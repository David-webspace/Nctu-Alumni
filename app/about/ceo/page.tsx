export default function CEOPage() {
  return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-yellow-50 py-10 flex items-center justify-center">
        <div className="bg-white/80 shadow-2xl rounded-2xl max-w-7xl w-full p-8 md:p-12 border border-blue-100">
            <h1 className="text-7xl md:text-4xl font-extrabold text-blue-900 mb-6 text-center tracking-wide drop-shadow-sm">
            理事長的話
            </h1>
            <div className="mb-8">
            ...
            <span className="inline-block text-base text-gray-500">郝挺</span>
            </div>
            <div className="space-y-7 text-gray-800 leading-relaxed">
            ...
            <blockquote className="border-l-4 border-blue-300 pl-4 italic text-blue-900 bg-blue-50/50 rounded py-2">
